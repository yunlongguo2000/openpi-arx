...
cd ~/openpi
uv venv --python 3.10 examples/aloha_arx_lift_real/.venv
source examples/aloha_arx_lift_real/.venv/bin/activate
uv pip sync examples/aloha_arx_lift_real/requirements.txt
uv pip install -e packages/openpi-client

# Run the robot
python -m examples.aloha_arx_lift_real.main
```
