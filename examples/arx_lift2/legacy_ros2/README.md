...
docker compose -f examples/aloha_arx_lift_real/compose.yml up --build
```
...
cd ~/openpi
uv venv --python 3.12 examples/aloha_arx_lift_ros2_real/.venv
source examples/aloha_arx_lift_ros2_real/.venv/bin/activate
uv pip compile examples/aloha_arx_lift_ros2_real/requirements.in -o examples/aloha_arx_lift_ros2_real/requirements.txt --python-version 3.12
uv pip sync examples/aloha_arx_lift_ros2_real/requirements.txt
uv pip install -e packages/openpi-client

# Run the robot (using wrapper script to handle ROS2/Conda library conflicts)
./examples/aloha_arx_lift_ros2_real/run_main.sh
python -m examples.aloha_arx_lift_ros2_real.main
```

# Quick start without editing
conda activate uv_envs
source examples/aloha_arx_lift_ros2_real/.venv/bin/activate
./examples/aloha_arx_lift_ros2_real/run_main.sh
...
uv run scripts/serve_policy.py --env ALOHA --default_prompt='put the water bottle in the box'
```
