...
from arm_control.msg import JointControl, PosCmd
from arx5_arm_msg.msg import RobotStatus as JointInformation

from examples.aloha_arx_lift_ros2_real.utils.controller import PIDController
...
class RosOperator(Node):
    ...
    def get_observations(self, ts=-1):  # get the robot observation
        img_data = {
            'cam_high': None,
            'cam_left_wrist': None,
        ...
        qpos = np.concatenate((np.array(arm_data['follow_left_arm'].joint_pos),
